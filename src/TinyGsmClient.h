...
#elif defined(TINY_GSM_MODEM_BC660)
#include "TinyGsmClientBC660.h"
typedef TinyGsmBC660                        TinyGsm;
typedef TinyGsmBC660::GsmClientBC660        TinyGsmClient;
typedef TinyGsmBC660::GsmClientSecureBC660  TinyGsmClientSecure;
