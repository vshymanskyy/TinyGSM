...
public:
  ...
  GsmClient(TinyGsmSim7020& modem, uint8_t mux = 1) {
    init(&modem, mux);
  }
...
TINY_GSM_MODEM_GET_INFO_ATI()
  ...
  /*
    During sleep, the SIM7020 module has its serial communication disabled. In order to reestablish communication
    pull the DRT-pin of the SIM7020 module LOW for at least 50ms. Then use this function to disable sleep mode.
